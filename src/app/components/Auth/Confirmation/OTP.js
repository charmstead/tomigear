    ...
    <section className="uk-flex uk-flex-center uk-flex-middle uk-text-center" uk-height-viewport="expand: true">
      <div>
        ...
        <p>
          ...
          <span className="uk-label uk-text-lowercase">dushyant@gmail.com</span> <Link href="/register">Change</Link>
        </p>
        ...
        <p className="uk-text-small">
          ...
          <button className="uk-text-small uk-text-lowercase uk-button uk-button-link">request to resend email</button>
        </p>
        <p className="uk-text-small">
          Still having trouble receiving e-mail? Contact us at{" "}
          <button className="uk-text-small uk-text-lowercase uk-button uk-button-link">support@tomigear.com</button>
        </p>
      </div>
    </section>
  );
